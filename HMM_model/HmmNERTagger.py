...
def hmm_nerf_tagger(sentence):
    helper = HMM('../train.data')
    sentence = sentence.replace(" ","").replace("\n","").replace("\r","")
    states = helper.states
    observations = helper.get_observation(sentence)
    ...
    print (pro,pathlist)
    print_tagger(pathlist,sentence)
    print("\n")
...
if __name__ == '__main__':
   ...
   # sentence = '截至2018年7月底,恒星公司为近5万家企业提供云计算服务。'
    sentence=  '2018年11月11日,马云在杭州宣布淘宝日交易额超过千亿.新华日报也对此进行了报道.'
